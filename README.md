...
2. <b>Running the R Script in the terminal:</b>
   ...
   3. <a id="third-heading"> Provide the values for number of initial samples, number of additional samples, and number of Monte Carlo iterations as arguments: </a><br>
        - Default values:<br>
